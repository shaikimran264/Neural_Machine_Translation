...
$$\text{chrP} = \frac{\text{# matched character n-grams in hypothesis}}{\text{# character n-grams in hypothesis}}$$

$$\text{chrR} = \frac{\text{# matched character n-grams in hypothesis}}{\text{# character n-grams in reference}}$$
...
📁 **[Google Drive – Required Files](https://drive.google.com/drive/folders/YOUR_SHARED_FOLDER_ID)**

> ⚠️ Replace the link above with your actual **publicly shared** Google Drive folder URL.
